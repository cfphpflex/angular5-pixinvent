...
//Horizontal menu Routes and data
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '', title: 'Apps', icon: 'ft-airplay', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false, submenu: [
    ...
    {
        path: '', title: 'Forms', icon: 'ft-edit', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false,
        submenu: [
            {
    ...
    {
        path: '', title: 'Charts', icon: 'ft-bar-chart-2', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false,
        submenu: [
