    ...
    { type: core.Component, args: [{
                ...
                animations: [
                    animations.trigger('fade', [
                        animations.state('visible', animations.style({ display: 'block', height: '*', width: '*' })),
                        animations.state('hidden', animations.style({ display: 'none', overflow: 'hidden', height: 0, width: 0 })),
                        animations.transition('hidden => visible', [
                            animations.animate('250ms ease-in', animations.keyframes([
                                ...
                                animations.style({ opacity: 1, offset: 1, height: '*', width: '*' }),
                            ]))
                        ]),
                        animations.transition('visible => hidden', [
                            animations.animate('350ms ease-out', animations.keyframes([
                                animations.style({ opacity: 1, offset: 0 }),
                                animations.style({ opacity: 0, offset: 1, width: '0', height: '0' }),
                            ]))
                        ])
                    ]),
