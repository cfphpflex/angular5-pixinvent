import { AfterViewInit, ElementRef, EventEmitter, NgZone, OnChanges, Renderer2, SimpleChanges } from '@angular/core';
...
export declare class QuillEditorComponent implements AfterViewInit, ControlValueAccessor, OnChanges, Validator {
    ...
    constructor(elementRef: ElementRef, doc: any, renderer: Renderer2, zone: NgZone);
